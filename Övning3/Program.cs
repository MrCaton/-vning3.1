...
namespace Övning3
{
    class Program
    {
       static void Main(string[] args)
        {
            List<Person> persons = SeedData();

            //SeedData måste vara en Datatyp för att kunna användas som generisk argument.
        ...
        //SeedData skapar personer men returneras inte
        ...
        private static List<Person> SeedData()
        {
